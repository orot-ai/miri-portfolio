-- Portfolio Database Initial Setup SQL
-- Run this file in Supabase SQL Editor

-- 1. Create portfolio_content table
...
-- 5. Insert initial portfolio_content data
...
-- 6. Insert initial projects data
...
-- 7. Insert initial site_settings data
...
-- Write access for authenticated users only (for future admin features)
